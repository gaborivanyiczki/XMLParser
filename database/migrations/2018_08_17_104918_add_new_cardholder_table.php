...
class AddNewCardholderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('new_cardholder', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('cho_middle_name')->nullable();
            $table->string('cho_last_name')->nullable();
    ...
    {
        Schema::dropIfExists('new_cardholder');
    }
}
